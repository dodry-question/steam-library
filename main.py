...
Дополнительный контекст: Игрок обычно любит эти игры: {core_names}. Можешь учитывать их атмосферу и стиль, но ЖАНР И СУТЬ игр должны СТРОГО соответствовать запросу '{custom_query}'.

СТРОГИЕ ПРАВИЛА:
1. ЗАПРЕЩЕНО советовать игры, которые уже есть у игрока: {owned_names}.{history_rule}
2. ЖАНР игр должен ТОЧНО соответствовать запросу '{custom_query}'. Это ВАЖНЕЕ истории игр.
...
Дополнительный контекст: Игрок выбрал эти игры из своей библиотеки: {targets_str}. Можешь учитывать их атмосферу и стиль, но ЖАНР И СУТЬ игр должны СТРОГО соответствовать запросу '{custom_query}'.

СТРОГИЕ ПРАВИЛА:
1. ЗАПРЕЩЕНО советовать игры, которые уже есть у игрока: {owned_names}.{history_rule}
2. ЖАНР игр должен ТОЧНО соответствовать запросу '{custom_query}'. Это ВАЖНЕЕ выбранных игр.
